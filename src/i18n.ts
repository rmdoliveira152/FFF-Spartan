...
type BoardNewsCopy = {
  navNews: string; newsLabel: string; newsTitle: string; newsIntro: string; newsHistory: string; noNews: string
  ...
  translationHint: string; confirmDeleteNews: string; newsImages: string; gameServerTime: string
}
...
const gameServerTimeCopy: Record<Language, string> = {
  en:'Game server time (UTC)', pt:'Hora do servidor do jogo (UTC)', es:'Hora del servidor del juego (UTC)', fr:'Heure du serveur du jeu (UTC)', de:'Spielserverzeit (UTC)', it:'Ora del server di gioco (UTC)', pl:'Czas serwera gry (UTC)', ru:'Время игрового сервера (UTC)', tr:'Oyun sunucusu saati (UTC)',
  id:'Waktu server game (UTC)', vi:'Giờ máy chủ trò chơi (UTC)', th:'เวลาเซิร์ฟเวอร์เกม (UTC)', ja:'ゲームサーバー時刻 (UTC)', ko:'게임 서버 시간 (UTC)', ar:'وقت خادم اللعبة (UTC)', 'zh-CN':'游戏服务器时间 (UTC)', 'zh-TW':'遊戲伺服器時間 (UTC)',
}
...
const en: BaseCopy = {
  ...
  alertText: 'Coming together is a beginning. Staying together is progress. Working together is success.',
...
const pt: BaseCopy = {
  ...
  alertText: 'Estar juntos é um começo. Permanecer juntos é progresso. Trabalhar juntos é sucesso.',
...
const translated: Record<Exclude<Language, 'en' | 'pt'>, BaseCopy> = {
  ...
  de: {
    ...
    enterRanks:'Mitglieder anzeigen',officialGame:'Offizielles Spiel',alertLabel:'Allianz-Anweisung',alertText:'Zusammenkommen ist ein Anfang. Zusammenbleiben ist ein Fortschritt. Zusammenarbeiten ist ein Erfolg.',
  ...
  it: {
    ...
    enterRanks:'Vedi membri',officialGame:'Gioco ufficiale',alertLabel:'Direttiva dell’alleanza',alertText:'Riunirsi è un inizio. Restare insieme è progresso. Lavorare insieme è successo.',
  ...
  pl: {
    ...
    enterRanks:'Zobacz członków',officialGame:'Oficjalna gra',alertLabel:'Dyrektywa sojuszu',alertText:'Spotkanie się to początek. Pozostanie razem to postęp. Wspólna praca to sukces.',
  ...
  ru: {
    ...
    enterRanks:'Смотреть состав',officialGame:'Официальная игра',alertLabel:'Директива альянса',alertText:'Собраться вместе — это начало. Оставаться вместе — это прогресс. Работать вместе — это успех.',
  ...
  tr: {
    ...
    enterRanks:'Üyeleri görüntüle',officialGame:'Resmî oyun',alertLabel:'İttifak direktifi',alertText:'Bir araya gelmek bir başlangıçtır. Birlikte kalmak ilerlemedir. Birlikte çalışmak başarıdır.',
  ...
  id: {
    ...
    enterRanks:'Lihat anggota',officialGame:'Game resmi',alertLabel:'Arahan aliansi',alertText:'Berkumpul bersama adalah awal. Tetap bersama adalah kemajuan. Bekerja bersama adalah kesuksesan.',
  ...
  vi: {
    ...
    enterRanks:'Xem thành viên',officialGame:'Trò chơi chính thức',alertLabel:'Chỉ thị liên minh',alertText:'Đến với nhau là sự khởi đầu. Ở bên nhau là sự tiến bộ. Làm việc cùng nhau là thành công.',
  ...
  th: {
    ...
    enterRanks:'ดูสมาชิก',officialGame:'เกมทางการ',alertLabel:'คำสั่งพันธมิตร',alertText:'การมารวมกันคือจุดเริ่มต้น การอยู่ร่วมกันคือความก้าวหน้า การทำงานร่วมกันคือความสำเร็จ',
  ...
  ja: {
    ...
    enterRanks:'メンバーを見る',officialGame:'公式ゲーム',alertLabel:'アライアンス指令',alertText:'共に集うことは始まり。共にいることは進歩。共に働くことは成功。',
    strength:'強さ',unity:'団結',discipline:'規律',rosterLabel:'アライアンス情報',rosterTitle:'FFF-Spartan メンバー',rosterText:'ランクと運用指標でメンバーの実績を比較します。',
    members:'名',updated:'本日更新',combatPower:'戦闘力',kills:'撃破数',weeklyContribution:'週間貢献',search:'サバイバーを検索',rank:'ランク',member:'メンバー',role:'役割',
    pollsLabel:'共同決定',pollsTitle:'開催中の投票',pollsText:'確認済みのアライアンスメンバーのみ投票できます。1人1票です。',active:'開催中',votes:'票',vote:'投票',
    pollOperation:'次のアライアンス作戦にはどのUTC時間帯を使いますか？',pollTraining:'週間訓練の優先項目は何にしますか？',rallyCoordination:'rally連携',defensiveFormations:'防御編成',resourceEfficiency:'資源効率',
  ...
  ko: {
    ...
    enterRanks:'연맹원 보기',officialGame:'공식 게임',alertLabel:'연맹 지시',alertText:'함께 모이는 것은 시작입니다. 함께하는 것은 발전입니다. 함께 일하는 것은 성공입니다.',
  ...
  ar: {
    ...
    enterRanks:'عرض الأعضاء',officialGame:'اللعبة الرسمية',alertLabel:'توجيه التحالف',alertText:'الاجتماع معًا بداية. والبقاء معًا تقدم. والعمل معًا نجاح.',
  ...
  'zh-CN': {
    ...
    enterRanks:'查看成员',officialGame:'官方游戏',alertLabel:'联盟指令',alertText:'相聚是开始，相守是进步，合作是成功。',
  ...
  'zh-TW': {
    ...
    enterRanks:'查看成員',officialGame:'官方遊戲',alertLabel:'聯盟指令',alertText:'相聚是開始，相守是進步，合作是成功。',
...
const boardNewsCopy: Record<Language, Omit<BoardNewsCopy, 'createdOn' | 'newsImages' | 'gameServerTime'>> = {
  ...
  fr: { navNews:'Actualités',newsLabel:'Tableau de commandement',newsTitle:'Board News',newsIntro:'Annonces officielles et communications opérationnelles du commandement de l’alliance.',newsHistory:'Historique des annonces',noNews:'Il n’y a pas encore d’annonce.',publishedOn:'Publié',expiresOn:'Valable jusqu’au',manageNews:'Gérer Board News',createNews:'Créer une annonce',editNews:'Modifier l’annonce',newsHeadline:'Titre',newsBody:'Message',sourceLanguage:'Langue d’origine',priority:'Priorité',standard:'Normale',important:'Importante',critical:'Critique',publishNow:'Publier maintenant',archive:'Archiver',restore:'Restaurer',draft:'Brouillon',translationHint:'Sélectionnez chaque langue pour ajouter ou vérifier sa traduction. Les langues vides utilisent la version originale.',confirmDeleteNews:'Supprimer définitivement cette annonce archivée ?' },
  de: { navNews:'Neuigkeiten',newsLabel:'Kommandotafel',newsTitle:'Board News',newsIntro:'Offizielle Ankündigungen und operative Mitteilungen der Allianzführung.',newsHistory:'Mitteilungsarchiv',noNews:'Noch keine Mitteilungen vorhanden.',publishedOn:'Veröffentlicht',expiresOn:'Gültig bis',manageNews:'Board News verwalten',createNews:'Mitteilung erstellen',editNews:'Mitteilung bearbeiten',newsHeadline:'Titel',newsBody:'Nachricht',sourceLanguage:'Originalsprache',priority:'Priorität',standard:'Standard',important:'Wichtig',critical:'Kritisch',publishNow:'Jetzt veröffentlichen',archive:'Archivieren',restore:'Wiederherstellen',draft:'Entwurf',translationHint:'Wähle jede Sprache aus, um ihre Übersetzung hinzuzufügen oder zu prüfen. Leere Sprachen verwenden die Originalversion.',confirmDeleteNews:'Diese archivierte Mitteilung endgültig löschen?' },
  it: { navNews:'Notizie',newsLabel:'Bacheca comando',newsTitle:'Board News',newsIntro:'Annunci ufficiali e comunicazioni operative della leadership dell’alleanza.',newsHistory:'Storico degli annunci',noNews:'Non ci sono ancora annunci.',publishedOn:'Pubblicato',expiresOn:'Valido fino al',manageNews:'Gestisci Board News',createNews:'Crea annuncio',editNews:'Modifica annuncio',newsHeadline:'Titolo',newsBody:'Messaggio',sourceLanguage:'Lingua originale',priority:'Priorità',standard:'Normale',important:'Importante',critical:'Critica',publishNow:'Pubblica ora',archive:'Archivia',restore:'Ripristina',draft:'Bozza',translationHint:'Seleziona ogni lingua per aggiungere o verificare la traduzione. Le lingue vuote usano la versione originale.',confirmDeleteNews:'Eliminare definitivamente questo annuncio archiviato?' },
  pl: { navNews:'Aktualności',newsLabel:'Tablica dowodzenia',newsTitle:'Board News',newsIntro:'Oficjalne ogłoszenia i komunikaty operacyjne dowództwa sojuszu.',newsHistory:'Historia ogłoszeń',noNews:'Nie ma jeszcze ogłoszeń.',publishedOn:'Opublikowano',expiresOn:'Ważne do',manageNews:'Zarządzaj Board News',createNews:'Utwórz ogłoszenie',editNews:'Edytuj ogłoszenie',newsHeadline:'Tytuł',newsBody:'Wiadomość',sourceLanguage:'Język oryginału',priority:'Priorytet',standard:'Standardowy',important:'Ważny',critical:'Krytyczny',publishNow:'Opublikuj teraz',archive:'Archiwizuj',restore:'Przywróć',draft:'Szkic',translationHint:'Wybierz każdy język, aby dodać lub sprawdzić tłumaczenie. Puste języki użyją wersji oryginalnej.',confirmDeleteNews:'Trwale usunąć to zarchiwizowane ogłoszenie?' },
  ru: { navNews:'Новости',newsLabel:'Доска командования',newsTitle:'Board News',newsIntro:'Официальные объявления и оперативные сообщения руководства альянса.',newsHistory:'История объявлений',noNews:'Объявлений пока нет.',publishedOn:'Опубликовано',expiresOn:'Действует до',manageNews:'Управление Board News',createNews:'Создать объявление',editNews:'Изменить объявление',newsHeadline:'Заголовок',newsBody:'Сообщение',sourceLanguage:'Исходный язык',priority:'Приоритет',standard:'Обычный',important:'Важный',critical:'Критический',publishNow:'Опубликовать сейчас',archive:'В архив',restore:'Восстановить',draft:'Черновик',translationHint:'Выберите каждый язык, чтобы добавить или проверить перевод. Для пустых языков используется оригинал.',confirmDeleteNews:'Навсегда удалить это архивное объявление?' },
  tr: { navNews:'Haberler',newsLabel:'Komuta panosu',newsTitle:'Board News',newsIntro:'İttifak liderliğinden resmî duyurular ve operasyon bildirimleri.',newsHistory:'Duyuru geçmişi',noNews:'Henüz duyuru yok.',publishedOn:'Yayınlandı',expiresOn:'Geçerlilik',manageNews:'Board News yönetimi',createNews:'Duyuru oluştur',editNews:'Duyuruyu düzenle',newsHeadline:'Başlık',newsBody:'Mesaj',sourceLanguage:'Orijinal dil',priority:'Öncelik',standard:'Normal',important:'Önemli',critical:'Kritik',publishNow:'Şimdi yayınla',archive:'Arşivle',restore:'Geri yükle',draft:'Taslak',translationHint:'Çeviri eklemek veya incelemek için her dili seçin. Boş diller orijinal sürümü kullanır.',confirmDeleteNews:'Bu arşivlenmiş duyuru kalıcı olarak silinsin mi?' },
  id: { navNews:'Berita',newsLabel:'Papan komando',newsTitle:'Board News',newsIntro:'Pengumuman resmi dan komunikasi operasional dari pimpinan aliansi.',newsHistory:'Riwayat pengumuman',noNews:'Belum ada pengumuman.',publishedOn:'Diterbitkan',expiresOn:'Berlaku sampai',manageNews:'Kelola Board News',createNews:'Buat pengumuman',editNews:'Edit pengumuman',newsHeadline:'Judul',newsBody:'Pesan',sourceLanguage:'Bahasa asli',priority:'Prioritas',standard:'Standar',important:'Penting',critical:'Kritis',publishNow:'Terbitkan sekarang',archive:'Arsipkan',restore:'Pulihkan',draft:'Draf',translationHint:'Pilih setiap bahasa untuk menambah atau memeriksa terjemahannya. Bahasa kosong memakai versi asli.',confirmDeleteNews:'Hapus pengumuman yang diarsipkan ini secara permanen?' },
  vi: { navNews:'Tin tức',newsLabel:'Bảng chỉ huy',newsTitle:'Board News',newsIntro:'Thông báo chính thức và liên lạc tác chiến từ ban lãnh đạo liên minh.',newsHistory:'Lịch sử thông báo',noNews:'Chưa có thông báo.',publishedOn:'Đã đăng',expiresOn:'Có hiệu lực đến',manageNews:'Quản lý Board News',createNews:'Tạo thông báo',editNews:'Sửa thông báo',newsHeadline:'Tiêu đề',newsBody:'Nội dung',sourceLanguage:'Ngôn ngữ gốc',priority:'Mức độ',standard:'Thông thường',important:'Quan trọng',critical:'Khẩn cấp',publishNow:'Đăng ngay',archive:'Lưu trữ',restore:'Khôi phục',draft:'Bản nháp',translationHint:'Chọn từng ngôn ngữ để thêm hoặc kiểm tra bản dịch. Ngôn ngữ trống sẽ dùng bản gốc.',confirmDeleteNews:'Xóa vĩnh viễn thông báo đã lưu trữ này?' },
  th: { navNews:'ข่าวสาร',newsLabel:'กระดานบัญชาการ',newsTitle:'Board News',newsIntro:'ประกาศอย่างเป็นทางการและการสื่อสารปฏิบัติการจากผู้นำพันธมิตร',newsHistory:'ประวัติประกาศ',noNews:'ยังไม่มีประกาศ',publishedOn:'เผยแพร่',expiresOn:'ใช้ได้ถึง',manageNews:'จัดการ Board News',createNews:'สร้างประกาศ',editNews:'แก้ไขประกาศ',newsHeadline:'หัวข้อ',newsBody:'ข้อความ',sourceLanguage:'ภาษาต้นฉบับ',priority:'ความสำคัญ',standard:'ปกติ',important:'สำคัญ',critical:'วิกฤต',publishNow:'เผยแพร่ตอนนี้',archive:'เก็บถาวร',restore:'กู้คืน',draft:'ฉบับร่าง',translationHint:'เลือกแต่ละภาษาเพื่อเพิ่มหรือตรวจสอบคำแปล ภาษาที่ว่างจะใช้ฉบับต้นฉบับ',confirmDeleteNews:'ลบประกาศที่เก็บถาวรนี้อย่างถาวรหรือไม่?' },
  ja: { navNews:'ニュース',newsLabel:'司令掲示板',newsTitle:'Board News',newsIntro:'同盟指導部からの公式発表と作戦連絡です。',newsHistory:'お知らせ履歴',noNews:'お知らせはまだありません。',publishedOn:'公開日',expiresOn:'有効期限',manageNews:'Board Newsを管理',createNews:'お知らせを作成',editNews:'お知らせを編集',newsHeadline:'見出し',newsBody:'本文',sourceLanguage:'元の言語',priority:'優先度',standard:'通常',important:'重要',critical:'緊急',publishNow:'今すぐ公開',archive:'アーカイブ',restore:'復元',draft:'下書き',translationHint:'各言語を選択して翻訳を追加または確認してください。空の言語には元の文章が使われます。',confirmDeleteNews:'このアーカイブ済みのお知らせを完全に削除しますか？' },
  ko: { navNews:'뉴스',newsLabel:'지휘 게시판',newsTitle:'Board News',newsIntro:'동맹 지도부의 공식 공지 및 작전 소식입니다.',newsHistory:'공지 기록',noNews:'아직 공지가 없습니다.',publishedOn:'게시일',expiresOn:'유효 기간',manageNews:'Board News 관리',createNews:'공지 작성',editNews:'공지 수정',newsHeadline:'제목',newsBody:'내용',sourceLanguage:'원본 언어',priority:'우선순위',standard:'일반',important:'중요',critical:'긴급',publishNow:'지금 게시',archive:'보관',restore:'복원',draft:'초안',translationHint:'각 언어를 선택하여 번역을 추가하거나 검토하세요. 비어 있는 언어는 원본을 사용합니다.',confirmDeleteNews:'이 보관된 공지를 영구 삭제하시겠습니까?' },
  ar: { navNews:'الأخبار',newsLabel:'لوحة القيادة',newsTitle:'Board News',newsIntro:'إعلانات رسمية واتصالات عملياتية من قيادة التحالف.',newsHistory:'سجل الإعلانات',noNews:'لا توجد إعلانات بعد.',publishedOn:'نُشر',expiresOn:'صالح حتى',manageNews:'إدارة Board News',createNews:'إنشاء إعلان',editNews:'تعديل الإعلان',newsHeadline:'العنوان',newsBody:'الرسالة',sourceLanguage:'اللغة الأصلية',priority:'الأولوية',standard:'عادي',important:'مهم',critical:'حرج',publishNow:'النشر الآن',archive:'أرشفة',restore:'استعادة',draft:'مسودة',translationHint:'اختر كل لغة لإضافة ترجمتها أو مراجعتها. تستخدم اللغات الفارغة النسخة الأصلية.',confirmDeleteNews:'حذف هذا الإعلان المؤرشف نهائياً؟' },
  'zh-CN': { navNews:'新闻',newsLabel:'指挥公告板',newsTitle:'Board News',newsIntro:'联盟管理层发布的官方公告和行动通知。',newsHistory:'公告历史',noNews:'暂无公告。',publishedOn:'发布时间',expiresOn:'有效期至',manageNews:'管理 Board News',createNews:'创建公告',editNews:'编辑公告',newsHeadline:'标题',newsBody:'内容',sourceLanguage:'原始语言',priority:'优先级',standard:'普通',important:'重要',critical:'紧急',publishNow:'立即发布',archive:'归档',restore:'恢复',draft:'草稿',translationHint:'选择各语言以添加或检查翻译。空白语言将使用原始版本。',confirmDeleteNews:'永久删除此已归档公告？' },
  'zh-TW': { navNews:'新聞',newsLabel:'指揮公告板',newsTitle:'Board News',newsIntro:'聯盟管理層發布的官方公告與行動通知。',newsHistory:'公告歷史',noNews:'尚無公告。',publishedOn:'發布時間',expiresOn:'有效至',manageNews:'管理 Board News',createNews:'建立公告',editNews:'編輯公告',newsHeadline:'標題',newsBody:'內容',sourceLanguage:'原始語言',priority:'優先級',standard:'一般',important:'重要',critical:'緊急',publishNow:'立即發布',archive:'封存',restore:'還原',draft:'草稿',translationHint:'選擇各語言以新增或檢查翻譯。空白語言將使用原始版本。',confirmDeleteNews:'永久刪除此已封存公告？' },
}

const createdOnCopy: Record<Language, string> = {
  en:'Created', pt:'Criado', es:'Creado', fr:'Créé', de:'Erstellt', it:'Creato', pl:'Utworzono', ru:'Создано', tr:'Oluşturuldu',
